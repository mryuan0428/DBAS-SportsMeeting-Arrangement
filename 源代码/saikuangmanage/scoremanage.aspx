<%@ Page Language="C#" AutoEventWireup="true" CodeFile="scoremanage.aspx.cs" Inherits="saikuangmanage_scoremanage" %>
            ...
            <table align="center" border="1" bordercolordark="#003399" bordercolorlight="#ffffff"
                ...
                <tr>
                    <td align="center" colspan="6" rowspan="7">
                        <asp:GridView ID="GridView1" runat="server" OnRowEditing="GridView1_RowEditing" OnRowUpdated="GridView1_RowUpdated" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowDataBound="GridView1_RowDataBound" OnRowUpdating="GridView1_RowUpdating" Width="533px">
                            <Columns>
                ...
                <tr>
                    <td align="center" colspan="6" style="height: 22px">
                        <asp:Button ID="paixu" runat="server" OnClick="paixu_Click" Text="排序" Width="100px" /></td>
                </tr>
            </table>
            <br />
        </div>
